...
extern double MACD_Period_Ratio = 1.00000000; // Period ratio between timeframes (0.5-1.5)
...
extern double RSI_Period_Ratio = 1; // Period ratio between timeframes (0.5-1.5)
