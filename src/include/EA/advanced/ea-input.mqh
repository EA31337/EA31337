...
extern int Alligator_Jaw_Period = 19; // Jaw Period
extern int Alligator_Jaw_Shift = 1; // Jaw Shift
extern int Alligator_Teeth_Period = 7; // Teeth Period
extern int Alligator_Teeth_Shift = 4; // Teeth Shift
extern int Alligator_Lips_Period = 7; // Lips Period
...
extern int Bands_OpenLevel = 0; // Open level
...
extern int MACD_Signal_Period = 10; // Period for signal
...
extern ENUM_TRAIL_TYPE RSI_TrailingStopMethod = T_MA_FMS_PEAK; // Trail stop method
extern ENUM_TRAIL_TYPE RSI_TrailingProfitMethod = T_FIXED; // Trail profit method
