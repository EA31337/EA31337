...
INPUT ENUM_MARKET_EVENT AC1_CloseCondition = 3; // Close condition for M1
INPUT int AC5_OpenCondition1 = 58; // Open condition 1 for M5 (0-1023)
INPUT int AC5_OpenCondition2 = 466; // Open condition 2 for M5 (0-)
INPUT ENUM_MARKET_EVENT AC5_CloseCondition = 31; // Close condition for M5
...
INPUT int AC30_OpenCondition1 = 77; // Open condition 1 for M30 (0-)
