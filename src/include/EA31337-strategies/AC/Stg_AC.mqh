...
INPUT uint AC_Active_Tf = 4; // Activate timeframes (1-255, e.g. M1=1,M5=2,M15=4,M30=8,H1=16,H2=32...)
INPUT ENUM_TRAIL_TYPE AC_TrailingStopMethod = 18; // Trail stop method
INPUT ENUM_TRAIL_TYPE AC_TrailingProfitMethod = 25; // Trail profit method
...
INPUT int AC30_SignalMethod = 0; // Signal method for M30 (0-1)
