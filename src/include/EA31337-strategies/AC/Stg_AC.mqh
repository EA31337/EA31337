...
INPUT int AC5_OpenCondition1 = 0; // Open condition 1 for M5 (0-1023)
...
INPUT int AC15_OpenCondition1 = 0; // Open condition 1 for M15 (0-)
...
INPUT int AC30_OpenCondition1 = 466; // Open condition 1 for M30 (0-)
