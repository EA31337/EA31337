...
INPUT uint AD_Active_Tf = 4; // Activate timeframes (1-255, e.g. M1=1,M5=2,M15=4,M30=8,H1=16,H2=32...)
INPUT ENUM_TRAIL_TYPE AD_TrailingStopMethod = 1; // Trail stop method
