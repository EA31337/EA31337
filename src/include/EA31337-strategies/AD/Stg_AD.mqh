...
#endif
#ifdef __advanced__
INPUT int AD1_OpenCondition1 = 311; // Open condition 1 for M1 (0-1023)
...
INPUT ENUM_MARKET_EVENT AD5_CloseCondition = 3; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT AD30_CloseCondition = 3; // Close condition for M30
#else
