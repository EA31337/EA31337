...
INPUT int ADX5_OpenCondition1 = 249; // Open condition 1 for M5 (0-1023)
INPUT int ADX5_OpenCondition2 = 962; // Open condition 2 for M5 (0-)
INPUT ENUM_MARKET_EVENT ADX5_CloseCondition = 4; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT ADX30_CloseCondition = 14; // Close condition for M30
#else
