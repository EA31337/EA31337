...
INPUT int ADX5_OpenCondition2 = 838; // Open condition 2 for M5 (0-)
INPUT ENUM_MARKET_EVENT ADX5_CloseCondition = 14; // Close condition for M5
...
INPUT int ADX30_OpenCondition1 = 32; // Open condition 1 for M30 (0-)
INPUT int ADX30_OpenCondition2 = 900; // Open condition 2 for M30 (0-)
