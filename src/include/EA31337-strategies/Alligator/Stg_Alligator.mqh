...
INPUT ENUM_TRAIL_TYPE Alligator_TrailingStopMethod = (ENUM_TRAIL_TYPE)7; // Trail stop method
INPUT ENUM_TRAIL_TYPE Alligator_TrailingProfitMethod = (ENUM_TRAIL_TYPE)25; // Trail profit method
...
INPUT ENUM_MARKET_EVENT Alligator1_CloseCondition = (ENUM_MARKET_EVENT)4; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT Alligator5_CloseCondition = (ENUM_MARKET_EVENT)4; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT Alligator15_CloseCondition = (ENUM_MARKET_EVENT)5; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT Alligator30_CloseCondition = (ENUM_MARKET_EVENT)11; // Close condition for M30
