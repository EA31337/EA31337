...
INPUT int Alligator_Period_Lips = 8; // Lips Period
INPUT int Alligator_Shift_Jaw = 2; // Jaw Shift
INPUT int Alligator_Shift_Teeth = 8; // Teeth Shift
INPUT int Alligator_Shift_Lips = 2; // Lips Shift
INPUT ENUM_MA_METHOD Alligator_MA_Method = 2; // MA Method
INPUT ENUM_APPLIED_PRICE Alligator_Applied_Price = (ENUM_APPLIED_PRICE) 2; // Applied Price
INPUT int Alligator_Shift = 0; // Shift
INPUT ENUM_TRAIL_TYPE Alligator_TrailingStopMethod = -6; // Trail stop method
...
INPUT int Alligator5_SignalMethod = 12; // Signal method for M5 (-63-63)
INPUT int Alligator15_SignalMethod = 25; // Signal method for M15 (-63-63)
INPUT int Alligator30_SignalMethod = 26; // Signal method for M30 (-63-63)
