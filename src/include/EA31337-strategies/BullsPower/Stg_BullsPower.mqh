...
ENUM_TRAIL_TYPE BullsPower_TrailingStopMethod = (ENUM_TRAIL_TYPE)22; // Trail stop method
ENUM_TRAIL_TYPE BullsPower_TrailingProfitMethod = (ENUM_TRAIL_TYPE)1; // Trail profit method
