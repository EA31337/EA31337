...
INPUT ENUM_MARKET_EVENT CCI1_CloseCondition = 20; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT CCI5_CloseCondition = 14; // Close condition for M5
INPUT int CCI15_OpenCondition1 = 1; // Open condition 1 for M15 (0-1023)
INPUT int CCI15_OpenCondition2 = 389; // Open condition 2 for M15 (0-1023)
INPUT ENUM_MARKET_EVENT CCI15_CloseCondition = 3; // Close condition for M15
