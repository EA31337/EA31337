...
INPUT ENUM_TRAIL_TYPE CCI_TrailingStopMethod = -20; // Trail stop method
INPUT ENUM_TRAIL_TYPE CCI_TrailingProfitMethod = -10; // Trail profit method
INPUT int CCI_Period_M1 = 18; // Period for M1
INPUT int CCI_Period_M5 = 18; // Period for M5
INPUT int CCI_Period_M15 = 2; // Period for M15
INPUT int CCI_Period_M30 = 10; // Period for M30
INPUT ENUM_APPLIED_PRICE CCI_Applied_Price = (ENUM_APPLIED_PRICE) 5; // Applied Price
INPUT double CCI_SignalLevel = 133; // Signal level (100 by default)
