...
INPUT ENUM_MARKET_EVENT DeMarker1_CloseCondition = 11; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT DeMarker5_CloseCondition = 14; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT DeMarker15_CloseCondition = 5; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT DeMarker30_CloseCondition = 3; // Close condition for M30
#else
