...
INPUT ENUM_TRAIL_TYPE DeMarker_TrailingStopMethod = (ENUM_TRAIL_TYPE)23; // Trail stop method
INPUT ENUM_TRAIL_TYPE DeMarker_TrailingProfitMethod = (ENUM_TRAIL_TYPE)22; // Trail profit method
...
INPUT ENUM_MARKET_EVENT DeMarker1_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT DeMarker5_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT DeMarker15_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT DeMarker30_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M30
