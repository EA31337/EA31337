...
INPUT int DeMarker_Period_M5 = 70; // Period for M5
INPUT int DeMarker_Period_M15 = 32; // Period for M15
...
#endif
#ifdef __advanced__
INPUT int DeMarker1_OpenCondition1 = 98; // Open condition 1 for M1 (0-1023)
INPUT int DeMarker1_OpenCondition2 = 98; // Open condition 2 for M1 (0-1023)
INPUT ENUM_MARKET_EVENT DeMarker1_CloseCondition = 4; // Close condition for M1
INPUT int DeMarker5_OpenCondition1 = 98; // Open condition 1 for M5 (0-1023)
INPUT int DeMarker5_OpenCondition2 = 971; // Open condition 2 for M5 (0-1023)
INPUT ENUM_MARKET_EVENT DeMarker5_CloseCondition = 11; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT DeMarker15_CloseCondition = 11; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT DeMarker30_CloseCondition = 29; // Close condition for M30
#else
