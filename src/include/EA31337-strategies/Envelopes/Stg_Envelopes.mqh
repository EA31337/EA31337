...
INPUT ENUM_TRAIL_TYPE Envelopes_TrailingProfitMethod = -24; // Trail profit method
...
INPUT int Envelopes15_SignalMethod = -106; // Signal method for M15 (-127-127)
INPUT int Envelopes30_SignalMethod = 71; // Signal method for M30 (-127-127)
