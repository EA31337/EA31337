...
INPUT int Force5_OpenCondition1 = 874; // Open condition 1 for M5 (0-1023)
INPUT int Force5_OpenCondition2 = 389; // Open condition 2 for M5 (0-)
...
INPUT int Force30_OpenCondition1 = 1; // Open condition 1 for M30 (0-)
INPUT int Force30_OpenCondition2 = 1; // Open condition 2 for M30 (0-)
