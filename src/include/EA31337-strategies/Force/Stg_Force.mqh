...
INPUT ENUM_TRAIL_TYPE Force_TrailingStopMethod = 13; // Trail stop method
INPUT ENUM_TRAIL_TYPE Force_TrailingProfitMethod = -20; // Trail profit method
INPUT int Force_Period_M1 = 2; // Period for M1
INPUT int Force_Period_M5 = 22; // Period for M5
INPUT int Force_Period_M15 = 18; // Period for M15
INPUT int Force_Period_M30 = 22; // Period for M30
INPUT ENUM_MA_METHOD Force_MA_Method = 0; // MA Method
INPUT ENUM_APPLIED_PRICE Force_Applied_Price = (ENUM_APPLIED_PRICE) 6; // Applied Price
INPUT double Force_SignalLevel = 0.9; // Signal level
