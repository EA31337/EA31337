...
INPUT ENUM_TRAIL_TYPE Force_TrailingStopMethod = (ENUM_TRAIL_TYPE)7; // Trail stop method
INPUT ENUM_TRAIL_TYPE Force_TrailingProfitMethod = (ENUM_TRAIL_TYPE)22; // Trail profit method
...
INPUT ENUM_MARKET_EVENT Force1_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT Force5_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT Force15_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT Force30_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M30
