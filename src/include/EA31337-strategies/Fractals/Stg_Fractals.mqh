...
INPUT ENUM_MARKET_EVENT Fractals15_CloseCondition = 3; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT Fractals30_CloseCondition = 19; // Close condition for M30
#else
