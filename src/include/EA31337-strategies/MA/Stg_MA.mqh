...
INPUT int MA_Shift_Medium = 15; // Shift Medium (+1)
...
INPUT ENUM_TRAIL_TYPE MA_TrailingStopMethod = -12; // Trail stop method
INPUT ENUM_TRAIL_TYPE MA_TrailingProfitMethod = -5; // Trail profit method
