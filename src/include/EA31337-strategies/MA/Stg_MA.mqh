...
INPUT ENUM_TRAIL_TYPE MA_TrailingStopMethod = (ENUM_TRAIL_TYPE)23; // Trail stop method
INPUT ENUM_TRAIL_TYPE MA_TrailingProfitMethod = (ENUM_TRAIL_TYPE)16; // Trail profit method
...
INPUT ENUM_MARKET_EVENT MA1_CloseCondition = (ENUM_MARKET_EVENT)24; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT MA5_CloseCondition = (ENUM_MARKET_EVENT)11; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT MA15_CloseCondition = (ENUM_MARKET_EVENT)24; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT MA30_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M30
