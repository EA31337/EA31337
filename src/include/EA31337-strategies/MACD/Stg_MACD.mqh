...
INPUT ENUM_TRAIL_TYPE MACD_TrailingStopMethod = (ENUM_TRAIL_TYPE)-1; // Trail stop method
INPUT ENUM_TRAIL_TYPE MACD_TrailingProfitMethod = (ENUM_TRAIL_TYPE)-19; // Trail profit method
...
INPUT ENUM_MARKET_EVENT MACD1_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT MACD5_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT MACD15_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT MACD30_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M30
