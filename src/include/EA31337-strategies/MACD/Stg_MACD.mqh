...
INPUT int MACD_Period_Fast = 3; // Period Fast
INPUT int MACD_Period_Slow = 20; // Period Slow
INPUT int MACD_Period_Signal = 7; // Period for signal
INPUT ENUM_APPLIED_PRICE MACD_Applied_Price = (ENUM_APPLIED_PRICE) 0; // Applied Price
INPUT int MACD_Shift = 0; // Shift
INPUT ENUM_TRAIL_TYPE MACD_TrailingStopMethod = 8; // Trail stop method
