...
INPUT uint MACD_Active_Tf = 8; // Activate timeframes (1-255, e.g. M1=1,M5=2,M15=4,M30=8,H1=16,H2=32...)
INPUT int MACD_Period_Fast = 6; // Period Fast
INPUT int MACD_Period_Slow = 22; // Period Slow
INPUT int MACD_Period_Signal = 3; // Period for signal
...
INPUT ENUM_TRAIL_TYPE MACD_TrailingProfitMethod = -7; // Trail profit method
INPUT double MACD_SignalLevel = 0.5; // Signal level
INPUT int MACD1_SignalMethod = -23; // Signal method for M1 (-31-31)
INPUT int MACD5_SignalMethod = -15; // Signal method for M5 (-31-31)
INPUT int MACD15_SignalMethod = -30; // Signal method for M15 (-31-31)
INPUT int MACD30_SignalMethod = -7; // Signal method for M30 (-31-31)
