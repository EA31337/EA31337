...
INPUT ENUM_TRAIL_TYPE MFI_TrailingStopMethod = 24; // Trail stop method
...
INPUT int MFI_Period_M15 = 16; // Period for M15
INPUT int MFI_Period_M30 = 4; // Period for M30
INPUT double MFI_SignalLevel = 1.1; // Signal level
