...
INPUT uint MFI_Active_Tf = 6; // Activate timeframes (1-255, e.g. M1=1,M5=2,M15=4,M30=8,H1=16,H2=32...)
INPUT ENUM_TRAIL_TYPE MFI_TrailingStopMethod = 15; // Trail stop method
INPUT ENUM_TRAIL_TYPE MFI_TrailingProfitMethod = -13; // Trail profit method
INPUT int MFI_Period_M1 = 20; // Period for M1
INPUT int MFI_Period_M5 = 32; // Period for M5
INPUT int MFI_Period_M15 = 36; // Period for M15
INPUT int MFI_Period_M30 = 2; // Period for M30
INPUT double MFI_SignalLevel = 2.1; // Signal level
