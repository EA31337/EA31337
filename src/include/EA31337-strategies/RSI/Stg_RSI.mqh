...
INPUT ENUM_TRAIL_TYPE RSI_TrailingStopMethod = (ENUM_TRAIL_TYPE)6; // Trail stop method
INPUT ENUM_TRAIL_TYPE RSI_TrailingProfitMethod = (ENUM_TRAIL_TYPE)11; // Trail profit method
...
INPUT ENUM_MARKET_EVENT RSI1_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT RSI5_CloseCondition = (ENUM_MARKET_EVENT)31; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT RSI15_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT RSI30_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M30
