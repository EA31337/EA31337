...
INPUT int RSI_Period_M5 = 12; // Period for M5
INPUT int RSI_Period_M15 = 2; // Period for M15
INPUT int RSI_Period_M30 = 10; // Period for M30
INPUT ENUM_APPLIED_PRICE RSI_Applied_Price = (ENUM_APPLIED_PRICE) 6; // Applied Price
INPUT uint RSI_Shift = 0; // Shift
INPUT ENUM_TRAIL_TYPE RSI_TrailingStopMethod = 2; // Trail stop method
INPUT ENUM_TRAIL_TYPE RSI_TrailingProfitMethod = 25; // Trail profit method
INPUT int RSI_SignalLevel = 34; // Signal level (-49-49)
