...
#endif
#ifdef __advanced__
INPUT int SAR1_OpenCondition1 = 874; // Open condition 1 for M1 (0-1023)
INPUT int SAR1_OpenCondition2 = 0; // Open condition 2 for M1 (0-1023)
INPUT ENUM_MARKET_EVENT SAR1_CloseCondition = 24; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT SAR5_CloseCondition = 24; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT SAR15_CloseCondition = 24; // Close condition for M15
INPUT int SAR30_OpenCondition1 = 98; // Open condition 1 for M30 (0-1023)
INPUT int SAR30_OpenCondition2 = 583; // Open condition 2 for M30 (0-1023)
INPUT ENUM_MARKET_EVENT SAR30_CloseCondition = 3; // Close condition for M30
#else
