...
#endif
#ifdef __advanced__
INPUT int SAR1_OpenCondition1 = 971;
INPUT int SAR1_OpenCondition2 = 971;
INPUT ENUM_MARKET_EVENT SAR1_CloseCondition = 13; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT SAR5_CloseCondition = 18; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT SAR15_CloseCondition = 11; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT SAR30_CloseCondition = 14; // Close condition for M30
#else
