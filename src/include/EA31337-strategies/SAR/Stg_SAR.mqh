...
INPUT ENUM_TRAIL_TYPE SAR_TrailingStopMethod = (ENUM_TRAIL_TYPE)7; // Trail stop method
INPUT ENUM_TRAIL_TYPE SAR_TrailingProfitMethod = (ENUM_TRAIL_TYPE)11; // Trail profit method
...
INPUT ENUM_MARKET_EVENT SAR1_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT SAR5_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT SAR15_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT SAR30_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M30
