...
INPUT uint SAR_Active_Tf = 12; // Activate timeframes (1-255, e.g. M1=1,M5=2,M15=4,M30=8,H1=16,H2=32...)
INPUT double SAR_Step = 0.09; // Step
INPUT double SAR_Maximum_Stop = 0.1; // Maximum stop
INPUT int SAR_Shift = 1; // Shift
INPUT ENUM_TRAIL_TYPE SAR_TrailingStopMethod = 1; // Trail stop method
INPUT ENUM_TRAIL_TYPE SAR_TrailingProfitMethod = -7; // Trail profit method
INPUT double SAR_SignalLevel = 0; // Signal level
INPUT int SAR1_SignalMethod = -99; // Signal method for M1 (-127-127)
INPUT int SAR5_SignalMethod = 7; // Signal method for M5 (-127-127)
