...
ENUM_TRAIL_TYPE StdDev_TrailingStopMethod = (ENUM_TRAIL_TYPE)22; // Trail stop method
ENUM_TRAIL_TYPE StdDev_TrailingProfitMethod = (ENUM_TRAIL_TYPE)1; // Trail profit method
