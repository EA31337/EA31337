...
INPUT ENUM_TRAIL_TYPE WPR_TrailingStopMethod = (ENUM_TRAIL_TYPE)22; // Trail stop method
INPUT ENUM_TRAIL_TYPE WPR_TrailingProfitMethod = (ENUM_TRAIL_TYPE)11; // Trail profit method
...
INPUT ENUM_MARKET_EVENT WPR1_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M1
...
INPUT ENUM_MARKET_EVENT WPR5_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT WPR15_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M15
...
INPUT ENUM_MARKET_EVENT WPR30_CloseCondition = (ENUM_MARKET_EVENT)1; // Close condition for M30
