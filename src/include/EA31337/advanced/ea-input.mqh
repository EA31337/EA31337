...
extern unsigned int Envelopes_Active_Tf = 6; // Envelopes: Activate timeframes
...
extern unsigned int SAR_Active_Tf = 2; // SAR: Activate timeframes
extern unsigned int WPR_Active_Tf = 2; // WPR: Activate timeframes
