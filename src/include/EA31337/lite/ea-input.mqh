...
extern ENUM_TRAIL_TYPE Alligator_TrailingProfitMethod = 1; // Trail profit method
...
extern int Alligator15_SignalMethod = 16; // Signal method for M15 (-63-63)
...
extern int DeMarker_Period = 22; // Period
extern double DeMarker_Period_Ratio = 2.1; // Period ratio between timeframes (0.5-1.5)
...
extern double Envelopes_MA_Period_Ratio = 0.1; // Period ratio between timeframes (0.5-1.5)
...
extern double Envelopes_Deviation_Ratio = 1.1; // Deviation ratio between timeframes (0.5-1.5)
...
extern int MA_Period_Slow = 54; // Period Slow
...
extern double MA_SignalLevel = 2.1; // Signal level
...
extern int MACD_Period_Slow = 27; // Period Slow
...
extern ENUM_TRAIL_TYPE MACD_TrailingStopMethod = 8; // Trail stop method
...
extern int WPR_Period = 3; // Period
