...
extern ENUM_TRAIL_TYPE Alligator_TrailingProfitMethod = 9; // Trail profit method
...
extern double CCI_SignalLevel = 102; // Signal level (100 by default)
...
extern uint RSI_Shift = 5; // Shift
extern ENUM_TRAIL_TYPE RSI_TrailingStopMethod = 19; // Trail stop method
extern ENUM_TRAIL_TYPE RSI_TrailingProfitMethod = 5; // Trail profit method
extern int RSI_SignalLevel = 16; // Signal level (-49-49)
...
extern int WPR_SignalLevel = -5; // Signal level
