...
extern uint   TickIgnoreMethod = 2; // Tick ignore method (0-5, 0 - off)

//+------------------------------------------------------------------+
extern string   __EA_Order_Parameters__ = "-- Profit and loss parameters --"; // >>> PROFIT/LOSS <<<
extern uint     TakeProfitMax = 80; // Max Take profit (in pips, 0 = auto)
...
extern double WorseDailyStrategyMultiplierFactor = 1; // Divider for the worse daily strategy
