...
extern double ConLossesIncreaseFactor = 1.4; // Increase lot factor on consequent loses (in %, 0 - off)
...
extern double Alligator_Period_Ratio = 1.4; // Period ratio between timeframes (0.5-1.5)
...
extern ENUM_APPLIED_PRICE Bands_Applied_Price = 6; // Applied Price
extern double Bands_Deviation = 1.9; // Deviation
...
extern ENUM_TRAIL_TYPE Bands_TrailingProfitMethod = -20; // Trail profit method
...
extern double CCI_Period_Ratio = 0.5; // Period ratio between timeframes (1.0 - default)
...
extern int CCI_Period = 22; // Period
extern ENUM_APPLIED_PRICE CCI_Applied_Price = 3; // Applied Price
extern double CCI_SignalLevel = 82; // Signal level (100 by default)
...
extern double DeMarker_Period_Ratio = 1.9; // Period ratio between timeframes (0.5-1.5)
extern int DeMarker_Shift = 2; // Shift
extern double DeMarker_SignalLevel = -0.5; // Signal level (0.0-0.4)
extern ENUM_TRAIL_TYPE DeMarker_TrailingStopMethod = 14; // Trail stop method
extern ENUM_TRAIL_TYPE DeMarker_TrailingProfitMethod = 23; // Trail profit method
extern int DeMarker1_SignalMethod = 8; // Signal method for M1 (-31-31)
extern int DeMarker5_SignalMethod = 1; // Signal method for M5 (-31-31)
extern int DeMarker15_SignalMethod = 8; // Signal method for M15 (-31-31)
extern int DeMarker30_SignalMethod = -16; // Signal method for M30 (-31-31)
...
extern double Envelopes_MA_Period_Ratio = 0.5; // Period ratio between timeframes (0.5-1.5)
...
extern double Envelopes_Deviation = 0.35; // Deviation for M1
...
extern int Fractals_Shift = 1; // Shift
...
extern int MA_Period_Fast = 8; // Period Fast
extern int MA_Period_Medium = 12; // Period Medium
extern int MA_Period_Slow = 6; // Period Slow
extern double MA_Period_Ratio = 0.5; // Period ratio between timeframes (0.5-1.5)
...
extern ENUM_APPLIED_PRICE MA_Applied_Price = 4; // Applied Price
...
extern double MA_SignalLevel = -0.2; // Signal level
...
ENUM_TRAIL_TYPE OSMA_TrailingStopMethod = 23; // Trail stop method
ENUM_TRAIL_TYPE OSMA_TrailingProfitMethod = 26; // Trail profit method
...
extern int RSI_Period = 2; // Period
extern double RSI_Period_Ratio = 1.3; // Period ratio between timeframes (0.5-1.5)
extern ENUM_APPLIED_PRICE RSI_Applied_Price = 0; // Applied Price
extern uint RSI_Shift = 9; // Shift
extern ENUM_TRAIL_TYPE RSI_TrailingStopMethod = -19; // Trail stop method
extern ENUM_TRAIL_TYPE RSI_TrailingProfitMethod = 16; // Trail profit method
extern int RSI_SignalLevel = 10; // Signal level (-49-49)
extern int RSI1_SignalMethod = -29; // Signal method for M1 (-63-63)
extern int RSI5_SignalMethod = 22; // Signal method for M5 (-63-63)
extern int RSI15_SignalMethod = 1; // Signal method for M15 (-63-63)
extern int RSI30_SignalMethod = 9; // Signal method for M30 (-63-63)
...
extern double SAR_Step_Ratio = 0.5; // Step ratio between timeframes (0.5-1.5)
extern double SAR_Maximum_Stop = 0.3; // Maximum stop
extern int SAR_Shift = 0; // Shift
extern ENUM_TRAIL_TYPE SAR_TrailingStopMethod = 26; // Trail stop method
...
extern double WPR_Period_Ratio = 1; // Period ratio between timeframes (0.5-1.5)
extern int WPR_Shift = 0; // Shift
extern int WPR_SignalLevel = -13; // Signal level
extern ENUM_TRAIL_TYPE WPR_TrailingStopMethod = 10; // Trail stop method
