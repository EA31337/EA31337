...
int CCI5_OpenCondition1 = 7; // Open condition 1 for M5 (0-1023)
int CCI5_OpenCondition2 = 5; // Open condition 2 for M5 (0-)
ENUM_MARKET_EVENT CCI5_CloseCondition = C_CCI_BUY_SELL; // Close condition for M5
int CCI15_OpenCondition1 = 7; // Open condition 1 for M15 (0-)
int CCI15_OpenCondition2 = 5; // Open condition 2 for M15 (0-)
ENUM_MARKET_EVENT CCI15_CloseCondition = C_CCI_BUY_SELL; // Close condition for M15
int CCI30_OpenCondition1 = 7; // Open condition 1 for M30 (0-)
int CCI30_OpenCondition2 = 5; // Open condition 2 for M30 (0-)
...
extern double Envelopes_Deviation_Ratio = 0.1; // Deviation ratio between timeframes (0.5-1.5)
