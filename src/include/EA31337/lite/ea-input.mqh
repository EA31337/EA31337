...
extern double MinPipChangeToTrade = 0.5; // Min pip change to trade (0 = every tick)
...
extern double RiskMarginPerOrder = 1.8; // Risk margin per order (in %, 0-100, 0 - auto, -1 - off)
extern double RiskMarginTotal = 13; // Risk margin in total (in %, 0-100, 0 - auto, -1 - off)
...
extern bool StrategyBoostByPF = false; // Boost strategy by its profit factor
extern bool StrategyHandicapByPF = false; // Handicap by its low profit factor
extern double BestDailyStrategyMultiplierFactor = 2.1; // Multiplier for the best daily strategy
...
extern double WorseWeeklyStrategyMultiplierFactor = 0.7; // Divider for the worse weekly strategy
...
extern double Alligator_Period_Ratio = 2; // Period ratio between timeframes (0.5-1.5)
extern int Alligator_Shift_Jaw = 0; // Jaw Shift
extern int Alligator_Shift_Teeth = 2; // Teeth Shift
extern int Alligator_Shift_Lips = 2; // Lips Shift
...
extern ENUM_TRAIL_TYPE Alligator_TrailingProfitMethod = 13; // Trail profit method
...
extern int Alligator15_SignalMethod = -63; // Signal method for M15 (-63-63)
...
extern int Bands_Period = 14; // Period
extern double Bands_Period_Ratio = 0.5; // Period ratio between timeframes (0.5-1.5)
extern ENUM_APPLIED_PRICE Bands_Applied_Price = 4; // Applied Price
extern double Bands_Deviation = 4.6; // Deviation
...
extern int Bands30_SignalMethod = -20; // Signal method for M30 (-127-127)
...
extern int DeMarker_Period = 10; // Period
extern double DeMarker_Period_Ratio = 2.6; // Period ratio between timeframes (0.5-1.5)
extern int DeMarker_Shift = 2; // Shift
extern double DeMarker_SignalLevel = 0; // Signal level (0.0-0.4)
extern ENUM_TRAIL_TYPE DeMarker_TrailingStopMethod = -6; // Trail stop method
extern ENUM_TRAIL_TYPE DeMarker_TrailingProfitMethod = -27; // Trail profit method
...
extern int Envelopes_MA_Period = 26; // Period
extern double Envelopes_MA_Period_Ratio = 1.1; // Period ratio between timeframes (0.5-1.5)
extern ENUM_MA_METHOD Envelopes_MA_Method = 0; // MA Method
extern int Envelopes_MA_Shift = 6; // MA Shift
extern ENUM_APPLIED_PRICE Envelopes_Applied_Price = 4; // Applied Price
extern double Envelopes_Deviation = 0.9; // Deviation for M1
extern double Envelopes_Deviation_Ratio = 0.8; // Deviation ratio between timeframes (0.5-1.5)
extern int Envelopes_Shift = 0; // Shift
int Envelopes_Shift_Far = 0; // Shift Far
extern ENUM_TRAIL_TYPE Envelopes_TrailingStopMethod = 0; // Trail stop method
extern ENUM_TRAIL_TYPE Envelopes_TrailingProfitMethod = -27; // Trail profit method
...
extern int Envelopes30_SignalMethod = -62; // Signal method for M30 (-127-127)
...
extern ENUM_TRAIL_TYPE Fractals_TrailingProfitMethod = -27; // Trail profit method
...
extern int MA_Period_Medium = 21; // Period Medium
extern int MA_Period_Slow = 52; // Period Slow
...
extern ENUM_MA_METHOD MA_Method = 2; // MA Method
extern ENUM_APPLIED_PRICE MA_Applied_Price = 1; // Applied Price
...
extern double MA_SignalLevel = 1.6; // Signal level
extern int MA1_SignalMethod = 56; // Signal method for M1 (-127-127)
extern int MA5_SignalMethod = -96; // Signal method for M5 (-127-127)
extern int MA15_SignalMethod = -64; // Signal method for M15 (-127-127)
extern int MA30_SignalMethod = 80; // Signal method for M30 (-127-127)
...
extern int MACD30_SignalMethod = -31; // Signal method for M30 (-31-31)
...
extern ENUM_TRAIL_TYPE RSI_TrailingStopMethod = -25; // Trail stop method
extern ENUM_TRAIL_TYPE RSI_TrailingProfitMethod = 1; // Trail profit method
extern int RSI_SignalLevel = -4; // Signal level
...
extern ENUM_TRAIL_TYPE SAR_TrailingStopMethod = -6; // Trail stop method
extern ENUM_TRAIL_TYPE SAR_TrailingProfitMethod = 0; // Trail profit method
extern double SAR_SignalLevel = -1.2; // Signal level
extern int SAR1_SignalMethod = 6; // Signal method for M1 (-127-127)
extern int SAR5_SignalMethod = 1; // Signal method for M5 (-127-127)
extern int SAR15_SignalMethod = 65; // Signal method for M15 (-127-127)
extern int SAR30_SignalMethod = 49; // Signal method for M30 (-127-127)
...
extern int WPR_Period = 1; // Period
...
extern ENUM_TRAIL_TYPE WPR_TrailingStopMethod = 3; // Trail stop method
