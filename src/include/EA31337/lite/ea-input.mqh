...
extern double RiskMarginPerOrder = 0.8; // Risk margin per order (in %, 0-100, 0 - auto, -1 - off)
...
extern double Alligator_SignalLevel = 0.09; // Signal level
...
extern int DeMarker_Period = 16; // Period
...
extern int Envelopes_MA_Shift = 8; // MA Shift
extern ENUM_APPLIED_PRICE Envelopes_Applied_Price = 4; // Applied Price
extern double Envelopes_Deviation = 1.1; // Deviation for M1
...
extern int MA_Period_Medium = 23; // Period Medium
...
extern double MA_SignalLevel = 2; // Signal level
...
extern int RSI_Period = 15; // Period
...
extern int RSI_SignalLevel = 30; // Signal level
...
extern double SAR_SignalLevel = -1.7; // Signal level
