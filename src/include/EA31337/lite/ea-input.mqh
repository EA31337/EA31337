...
extern int CloseOrderAfterXHours = 120; // Close order after X hours (>0 - only profitable, <0 - all, 0 - off)
...
extern double BestWeeklyStrategyMultiplierFactor = 1.1; // Multiplier for the best weekly strategy
extern double BestMonthlyStrategyMultiplierFactor = 1.1; // Multiplier for the best monthly strategy
extern double WorseDailyStrategyMultiplierFactor = 0.9; // Multiplier for the worse daily strategy
extern double WorseWeeklyStrategyMultiplierFactor = 0.9; // Multiplier for the worse weekly strategy
extern double WorseMonthlyStrategyMultiplierFactor = 0.8; // Multiplier for the worse monthly strategy
extern double ConWinsIncreaseFactor = 1.1; // Increase lot factor on consequent wins (in %, 0 - off)
extern double ConLossesIncreaseFactor = 1.1; // Increase lot factor on consequent loses (in %, 0 - off)
extern uint ConFactorOrdersLimit = 300; // No of orders to check on consequent wins/loses
...
extern int Alligator_Period_Jaw = 8; // Jaw Period
...
extern ENUM_TRAIL_TYPE Alligator_TrailingStopMethod = 14; // Trail stop method
extern ENUM_TRAIL_TYPE Alligator_TrailingProfitMethod = 4; // Trail profit method
extern double Alligator_SignalLevel = -0.2; // Signal level
extern int Alligator1_SignalMethod = 17; // Signal method for M1 (-63-63)
extern int Alligator5_SignalMethod = -8; // Signal method for M5 (-63-63)
extern int Alligator15_SignalMethod = -15; // Signal method for M15 (-63-63)
extern int Alligator30_SignalMethod = 19; // Signal method for M30 (-63-63)
...
extern double Bands_Deviation = 2.2; // Deviation
extern double Bands_Deviation_Ratio = 1; // Deviation ratio between timeframes (0.5-1.5)
extern int Bands_Shift = 2; // Shift
extern int Bands_Shift_Far = 2; // Shift Far
extern ENUM_TRAIL_TYPE Bands_TrailingStopMethod = 9; // Trail stop method
extern ENUM_TRAIL_TYPE Bands_TrailingProfitMethod = 27; // Trail profit method
/* @todo extern */ int Bands_SignalLevel = 0; // Signal level
extern int Bands1_SignalMethod = -10; // Signal method for M1 (-127-127)
extern int Bands5_SignalMethod = 0; // Signal method for M5 (-127-127)
extern int Bands15_SignalMethod = -90; // Signal method for M15 (-127-127)
extern int Bands30_SignalMethod = -90; // Signal method for M30 (-127-127)
...
extern double CCI_Period_Ratio = 1.0; // Period ratio between timeframes (1.0 - default)
extern int CCI_Shift = 2; // Shift (0 for default)
extern ENUM_TRAIL_TYPE CCI_TrailingStopMethod = -27; // Trail stop method
extern ENUM_TRAIL_TYPE CCI_TrailingProfitMethod = -2; // Trail profit method
extern int CCI_Period = 30; // Period
extern ENUM_APPLIED_PRICE CCI_Applied_Price = 2; // Applied Price
extern double CCI_SignalLevel = 92; // Signal level (100 by default)
extern int CCI1_SignalMethod = -63; // Signal method for M1 (0-
extern int CCI5_SignalMethod = -63; // Signal method for M5 (0-
extern int CCI15_SignalMethod = -63; // Signal method for M15 (0-
extern int CCI30_SignalMethod = -32; // Signal method for M30 (0-
int CCI1_OpenCondition1 = 0; // Open condition 1 for M1 (0-11)
int CCI1_OpenCondition2 = 0; // Open condition 2 for M1 (0-11)
ENUM_MARKET_EVENT CCI1_CloseCondition = C_CCI_BUY_SELL; // Close condition for M1
int CCI5_OpenCondition1 = 0; // Open condition 1 for M5 (0-11)
int CCI5_OpenCondition2 = 0; // Open condition 2 for M5 (0-11)
ENUM_MARKET_EVENT CCI5_CloseCondition = C_CCI_BUY_SELL; // Close condition for M5
int CCI15_OpenCondition1 = 0; // Open condition 1 for M15 (0-11)
...
int CCI30_OpenCondition1 = 0; // Open condition 1 for M30 (0-11)
int CCI30_OpenCondition2 = 0; // Open condition 2 for M30 (0-11)
...
extern int DeMarker_Period = 8; // Period
extern double DeMarker_Period_Ratio = 1.0; // Period ratio between timeframes (0.5-1.5)
extern int DeMarker_Shift = 1; // Shift
extern double DeMarker_SignalLevel = -0.5; // Signal level (0.0-0.4)
extern ENUM_TRAIL_TYPE DeMarker_TrailingStopMethod = 8; // Trail stop method
extern ENUM_TRAIL_TYPE DeMarker_TrailingProfitMethod = -5; // Trail profit method
extern int DeMarker1_SignalMethod = 12; // Signal method for M1 (-31-31)
extern int DeMarker5_SignalMethod = 3; // Signal method for M5 (-31-31)
extern int DeMarker15_SignalMethod = -18; // Signal method for M15 (-31-31)
...
extern int Envelopes_MA_Period = 22; // Period
...
extern double Envelopes_Deviation = 0.55; // Deviation for M1
...
extern ENUM_TRAIL_TYPE Envelopes_TrailingProfitMethod = 3; // Trail profit method
/* @todo extern */ int Envelopes_SignalLevel = 0; // Signal level
extern int Envelopes1_SignalMethod = 24; // Signal method for M1 (-127-127)
extern int Envelopes5_SignalMethod = -68; // Signal method for M5 (-127-127)
extern int Envelopes15_SignalMethod = 49; // Signal method for M15 (-127-127)
extern int Envelopes30_SignalMethod = -19; // Signal method for M30 (-127-127)
...
extern ENUM_TRAIL_TYPE Fractals_TrailingStopMethod = -26; // Trail stop method
extern ENUM_TRAIL_TYPE Fractals_TrailingProfitMethod = 25; // Trail profit method
...
extern int MA_Period_Medium = 14; // Period Medium
extern int MA_Period_Slow = 6; // Period Slow
extern double MA_Period_Ratio = 1.0; // Period ratio between timeframes (0.5-1.5)
extern int MA_Shift = 7; // Shift
extern int MA_Shift_Fast = 10; // Shift Fast (+1)
extern int MA_Shift_Medium = 9; // Shift Medium (+1)
...
extern ENUM_TRAIL_TYPE MA_TrailingStopMethod = 6; // Trail stop method
extern ENUM_TRAIL_TYPE MA_TrailingProfitMethod = -27; // Trail profit method
extern double MA_SignalLevel = -0.4; // Signal level
extern int MA1_SignalMethod = 127; // Signal method for M1 (-127-127)
extern int MA5_SignalMethod = 106; // Signal method for M5 (-127-127)
extern int MA15_SignalMethod = -126; // Signal method for M15 (-127-127)
extern int MA30_SignalMethod = -126; // Signal method for M30 (-127-127)
...
extern int MACD_Period_Fast = 17; // Period Fast
extern int MACD_Period_Slow = 31; // Period Slow
extern int MACD_Period_Signal = 8; // Period for signal
...
extern int MACD1_SignalMethod = -27; // Signal method for M1 (-31-31)
extern int MACD5_SignalMethod = -8; // Signal method for M5 (-31-31)
extern int MACD15_SignalMethod = 4; // Signal method for M15 (-31-31)
...
ENUM_TRAIL_TYPE OSMA_TrailingStopMethod = 27; // Trail stop method
...
extern ENUM_TRAIL_TYPE RSI_TrailingStopMethod = 19; // Trail stop method
extern ENUM_TRAIL_TYPE RSI_TrailingProfitMethod = 8; // Trail profit method
extern int RSI_SignalLevel = 26; // Signal level (-49-49)
extern int RSI1_SignalMethod = 24; // Signal method for M1 (-63-63)
extern int RSI5_SignalMethod = -63; // Signal method for M5 (-63-63)
extern int RSI15_SignalMethod = -61; // Signal method for M15 (-63-63)
extern int RSI30_SignalMethod = -61; // Signal method for M30 (-63-63)
...
extern double SAR_Step_Ratio = 1.0; // Step ratio between timeframes (0.5-1.5)
...
extern ENUM_TRAIL_TYPE SAR_TrailingProfitMethod = -27; // Trail profit method
extern double SAR_SignalLevel = 0.00000000; // Signal level
extern int SAR1_SignalMethod = -2; // Signal method for M1 (-127-127)
extern int SAR5_SignalMethod = 32; // Signal method for M5 (-127-127)
extern int SAR15_SignalMethod = -124; // Signal method for M15 (-127-127)
extern int SAR30_SignalMethod = -112; // Signal method for M30 (-127-127)
...
extern int WPR_Period = 10; // Period
extern double WPR_Period_Ratio = 1.0; // Period ratio between timeframes (0.5-1.5)
extern int WPR_Shift = 0; // Shift
extern int WPR_SignalLevel = 40; // Signal level
extern ENUM_TRAIL_TYPE WPR_TrailingStopMethod = -27; // Trail stop method
extern ENUM_TRAIL_TYPE WPR_TrailingProfitMethod = -9; // Trail profit method
extern int WPR1_SignalMethod = -45; // Signal method for M1 (-63-63)
extern int WPR5_SignalMethod = -29; // Signal method for M5 (-63-63)
extern int WPR15_SignalMethod = -30; // Signal method for M15 (-63-63)
extern int WPR30_SignalMethod = -32; // Signal method for M30 (-63-63)
