...
extern unsigned int Alligator_Active_Tf = 3; // Alligator: Activate timeframes
extern unsigned int Bands_Active_Tf = 7; // Bands: Activate timeframes
extern unsigned int CCI_Active_Tf = 3; // CCI: Activate timeframes
extern unsigned int DeMarker_Active_Tf = 3; // DeMarker: Activate timeframes
extern unsigned int Envelopes_Active_Tf = 3; // Envelopes: Activate timeframes
extern unsigned int Force_Active_Tf = 3; // Force: Activate timeframes
extern unsigned int Fractals_Active_Tf = 11; // Fractals: Activate timeframes
extern unsigned int MACD_Active_Tf = 3; // MACD: Activate timeframes
extern unsigned int MA_Active_Tf = 2; // MA: Activate timeframes
extern unsigned int MFI_Active_Tf = 11; // MFI: Activate timeframes
extern unsigned int RSI_Active_Tf = 3; // RSI: Activate timeframes
extern unsigned int SAR_Active_Tf = 11; // SAR: Activate timeframes
...
extern ENUM_TIMEFRAMES TrendPeriod = PERIOD_M15; // Period for trend calculation
