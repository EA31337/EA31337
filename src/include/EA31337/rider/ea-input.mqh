...
extern ENUM_MARKET_EVENT AC1_CloseCondition = 0; // Close condition for M1
...
extern ENUM_MARKET_EVENT AC5_CloseCondition = 0; // Close condition for M5

extern int AC15_OpenCondition1 = 1; // Open condition 1 for M15 (0-)
extern int AC15_OpenCondition2 = 1; // Open condition 2 for M15 (0-)
extern ENUM_MARKET_EVENT AC15_CloseCondition = 0; // Close condition for M15
...
extern ENUM_MARKET_EVENT AC30_CloseCondition = 0; // Close condition for M30
...
extern ENUM_MARKET_EVENT AD1_CloseCondition = 0; // Close condition for M1
...
extern ENUM_MARKET_EVENT AD5_CloseCondition = 0; // Close condition for M5

extern int AD15_OpenCondition1 = 292; // Open condition 1 for M15 (0-)
extern int AD15_OpenCondition2 = 1; // Open condition 2 for M15 (0-)
extern ENUM_MARKET_EVENT AD15_CloseCondition = 0; // Close condition for M15
...
extern ENUM_MARKET_EVENT AD30_CloseCondition = 0; // Close condition for M30
...
extern ENUM_MARKET_EVENT ADX1_CloseCondition = 0; // Close condition for M1
...
extern ENUM_MARKET_EVENT ADX5_CloseCondition = 0; // Close condition for M5

extern int ADX15_OpenCondition1 = 1; // Open condition 1 for M15 (0-)
extern int ADX15_OpenCondition2 = 1; // Open condition 2 for M15 (0-)
extern ENUM_MARKET_EVENT ADX15_CloseCondition = 0; // Close condition for M15
...
extern ENUM_MARKET_EVENT ADX30_CloseCondition = 0; // Close condition for M30
...
extern uint Alligator_Active_Tf = 13; // Activate timeframes (1-255, e.g. M1=1,M5=2,M15=4,M30=8,H1=16,H2=32...)
...
extern ENUM_MARKET_EVENT Alligator1_CloseCondition = 0; // Close condition for M1
//
...
extern ENUM_MARKET_EVENT Alligator5_CloseCondition = 0; // Close condition for M5
//
...
extern ENUM_MARKET_EVENT Alligator15_CloseCondition = 0; // Close condition for M15
//
...
extern ENUM_MARKET_EVENT Alligator30_CloseCondition = 0; // Close condition for M30
//
...
extern ENUM_MARKET_EVENT Bands1_CloseCondition = 0; // Close condition for M1
...
extern ENUM_MARKET_EVENT Bands5_CloseCondition = 0; // Close condition for M5
...
extern ENUM_MARKET_EVENT Bands15_CloseCondition = 0; // Close condition for M15
...
extern ENUM_MARKET_EVENT Bands30_CloseCondition = 0; // Close condition for M30
...
ENUM_MARKET_EVENT BearsPower1_CloseCondition = 0; // Close condition for M1
...
ENUM_TRAIL_TYPE BullsPower_TrailingStopMethod = 0; // Trail stop method
ENUM_TRAIL_TYPE BullsPower_TrailingProfitMethod = 0; // Trail profit method
...
ENUM_MARKET_EVENT BullsPower1_CloseCondition = 0; // Close condition for M1
...
extern uint CCI_Active_Tf = 14; // Activate timeframes (1-255, e.g. M1=1,M5=2,M15=4,M30=8,H1=16,H2=32...)
...
extern ENUM_MARKET_EVENT CCI1_CloseCondition = 0; // Close condition for M1
...
extern ENUM_MARKET_EVENT CCI5_CloseCondition = 0; // Close condition for M5
...
extern ENUM_MARKET_EVENT CCI15_CloseCondition = 0; // Close condition for M15
...
extern ENUM_MARKET_EVENT CCI30_CloseCondition = 0; // Close condition for M30
...
extern ENUM_MARKET_EVENT DeMarker1_CloseCondition = 0; // Close condition for M1
//
...
extern ENUM_MARKET_EVENT DeMarker5_CloseCondition = 0; // Close condition for M5
//
...
extern ENUM_MARKET_EVENT DeMarker15_CloseCondition = 0; // Close condition for M15
//
...
extern ENUM_MARKET_EVENT DeMarker30_CloseCondition = 0; // Close condition for M30
//
...
extern ENUM_MARKET_EVENT Envelopes1_CloseCondition = 0; // Close condition for M1
//
...
extern ENUM_MARKET_EVENT Envelopes5_CloseCondition = 0; // Close condition for M5
//
...
extern ENUM_MARKET_EVENT Envelopes15_CloseCondition = 0; // Close condition for M15
//
...
extern ENUM_MARKET_EVENT Envelopes30_CloseCondition = 0; // Close condition for M30
//
...
extern ENUM_MARKET_EVENT Force1_CloseCondition = 0; // Close condition for M1
...
extern ENUM_MARKET_EVENT Force5_CloseCondition = 0; // Close condition for M5
...
extern ENUM_MARKET_EVENT Force15_CloseCondition = 0; // Close condition for M15
...
extern ENUM_MARKET_EVENT Force30_CloseCondition = 0; // Close condition for M30
...
extern ENUM_MARKET_EVENT Fractals1_CloseCondition = 0; // Close condition for M1
//
...
extern ENUM_MARKET_EVENT Fractals5_CloseCondition = 0; // Close condition for M5
//
...
extern ENUM_MARKET_EVENT Fractals15_CloseCondition = 0; // Close condition for M15
//
...
extern ENUM_MARKET_EVENT Fractals30_CloseCondition = 0; // Close condition for M30
//
...
ENUM_TRAIL_TYPE Ichimoku_TrailingStopMethod = 0; // Trail stop method
ENUM_TRAIL_TYPE Ichimoku_TrailingProfitMethod = 0; // Trail profit method
...
extern ENUM_MARKET_EVENT MA1_CloseCondition = 0; // Close condition for M1
//
...
extern ENUM_MARKET_EVENT MA5_CloseCondition = 0; // Close condition for M5
//
...
extern ENUM_MARKET_EVENT MA15_CloseCondition = 0; // Close condition for M15
//
...
extern ENUM_MARKET_EVENT MA30_CloseCondition = 0; // Close condition for M30
//
...
extern ENUM_MARKET_EVENT MACD1_CloseCondition = 0; // Close condition for M1
//
...
extern ENUM_MARKET_EVENT MACD5_CloseCondition = 0; // Close condition for M5
//
...
extern ENUM_MARKET_EVENT MACD15_CloseCondition = 0; // Close condition for M15
//
...
extern ENUM_MARKET_EVENT MACD30_CloseCondition = 0; // Close condition for M30
//
...
extern ENUM_MARKET_EVENT MFI1_CloseCondition = 0; // Close condition for M1

extern int MFI5_OpenCondition1 = 1; // Open condition 1 for M5 (0-1023)
extern int MFI5_OpenCondition2 = 680; // Open condition 2 for M5 (0-)
extern ENUM_MARKET_EVENT MFI5_CloseCondition = 0; // Close condition for M5
...
extern ENUM_MARKET_EVENT MFI15_CloseCondition = 0; // Close condition for M15
...
extern ENUM_MARKET_EVENT MFI30_CloseCondition = 0; // Close condition for M30
...
extern ENUM_MARKET_EVENT RSI1_CloseCondition = 0; // Close condition for M1

extern int RSI5_OpenCondition1 = 1; // Open condition 1 for M5 (0-1023)
extern int RSI5_OpenCondition2 = 98; // Open condition 2 for M5 (0-1023)
extern ENUM_MARKET_EVENT RSI5_CloseCondition = 0; // Close condition for M5

extern int RSI15_OpenCondition1 = 389; // Open condition 1 for M15 (0-1023)
extern int RSI15_OpenCondition2 = 292; // Open condition 2 for M15 (0-1023)
extern ENUM_MARKET_EVENT RSI15_CloseCondition = 0; // Close condition for M15

extern int RSI30_OpenCondition1 = 195; // Open condition 1 for M30 (0-1023)
extern int RSI30_OpenCondition2 = 98; // Open condition 2 for M30 (0-1023)
extern ENUM_MARKET_EVENT RSI30_CloseCondition = 0; // Close condition for M30
...
extern ENUM_MARKET_EVENT SAR1_CloseCondition = 0; // Close condition for M1
...
extern ENUM_MARKET_EVENT SAR5_CloseCondition = 0; // Close condition for M5
...
extern ENUM_MARKET_EVENT SAR15_CloseCondition = 0; // Close condition for M15
...
extern ENUM_MARKET_EVENT SAR30_CloseCondition = 0; // Close condition for M30
...
ENUM_MARKET_EVENT Stochastic1_CloseCondition = 0; // Close condition for M1
...
ENUM_TRAIL_TYPE WPR_TrailingStopMethod = 0; // Trail stop method
ENUM_TRAIL_TYPE WPR_TrailingProfitMethod = 0; // Trail profit method
...
extern ENUM_MARKET_EVENT WPR1_CloseCondition = 0; // Close condition for M1
//
...
extern ENUM_MARKET_EVENT WPR5_CloseCondition = 0; // Close condition for M5
//
...
extern ENUM_MARKET_EVENT WPR15_CloseCondition = 0; // Close condition for M15
//
...
extern ENUM_MARKET_EVENT WPR30_CloseCondition = 0; // Close condition for M30
//
