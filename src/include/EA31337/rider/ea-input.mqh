...
extern unsigned int AD_Active_Tf = 9; // AD: Activate timeframes
extern unsigned int ADX_Active_Tf = 1; // ADX: Activate timeframes
extern unsigned int Alligator_Active_Tf = 1; // Alligator: Activate timeframes
extern unsigned int Bands_Active_Tf = 1; // Bands: Activate timeframes
...
extern unsigned int MA_Active_Tf = 3; // MA: Activate timeframes
extern unsigned int MFI_Active_Tf = 8; // MFI: Activate timeframes
