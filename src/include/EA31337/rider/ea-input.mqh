...
extern int InitNoOfDaysToWarmUp = 0; // Initial warm-up period (in days)
...
extern double BestDailyStrategyMultiplierFactor = 0; // Multiplier for the best daily strategy
extern double BestWeeklyStrategyMultiplierFactor = 0; // Multiplier for the best weekly strategy
extern double BestMonthlyStrategyMultiplierFactor = 1.6; // Multiplier for the best monthly strategy
...
extern double WorseMonthlyStrategyMultiplierFactor = 2.4; // Multiplier for the worse monthly strategy
extern double ConWinsIncreaseFactor = -2; // Increase lot factor on consequent wins (in %, 0 - off)
...
extern unsigned int ADX_Active_Tf = 10; // ADX: Activate timeframes
extern unsigned int Alligator_Active_Tf = 14; // Alligator: Activate timeframes
extern unsigned int Bands_Active_Tf = 10; // Bands: Activate timeframes
extern unsigned int CCI_Active_Tf = 10; // CCI: Activate timeframes
extern unsigned int DeMarker_Active_Tf = 10; // DeMarker: Activate timeframes
extern unsigned int Envelopes_Active_Tf = 10; // Envelopes: Activate timeframes
extern unsigned int Force_Active_Tf = 10; // Force: Activate timeframes
extern unsigned int Fractals_Active_Tf = 14; // Fractals: Activate timeframes
extern unsigned int MACD_Active_Tf = 10; // MACD: Activate timeframes
extern unsigned int MA_Active_Tf = 2; // MA: Activate timeframes
extern unsigned int MFI_Active_Tf = 10; // MFI: Activate timeframes
extern unsigned int RSI_Active_Tf = 10; // RSI: Activate timeframes
extern unsigned int SAR_Active_Tf = 10; // SAR: Activate timeframes
extern unsigned int WPR_Active_Tf = 10; // WPR: Activate timeframes
