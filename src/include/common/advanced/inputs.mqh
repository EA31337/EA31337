...
input ENUM_STRATEGY Strategy_M30 = (ENUM_STRATEGY)29;                      // Strategy on M30
...
input ENUM_STRATEGY EA_Stops_M15 = (ENUM_STRATEGY)24;          // Stop loss on M15
input ENUM_STRATEGY EA_Stops_M30 = (ENUM_STRATEGY)23;          // Stop loss on M30
...
input int EA_OrderCloseTime_M15 = -20;                                // Close time on M15 in mins (>0) or bars (<0)
input int EA_OrderCloseTime_M30 = -30;                                // Close time on M30 in mins (>0) or bars (<0)
