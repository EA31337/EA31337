...
input ENUM_STRATEGY EA_Stops_M1 = (ENUM_STRATEGY)4;            // Stop loss on M1
input ENUM_STRATEGY EA_Stops_M5 = (ENUM_STRATEGY)4;            // Stop loss on M5
input ENUM_STRATEGY EA_Stops_M15 = (ENUM_STRATEGY)29;          // Stop loss on M15
input ENUM_STRATEGY EA_Stops_M30 = (ENUM_STRATEGY)14;          // Stop loss on M30
