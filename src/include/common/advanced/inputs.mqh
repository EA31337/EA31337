...
input ENUM_STRATEGY Strategy_M5 = STRAT_STDDEV;     // Strategy on M5
input ENUM_STRATEGY Strategy_M15 = STRAT_BANDS;     // Strategy on M15
input ENUM_STRATEGY Strategy_M30 = STRAT_WPR;       // Strategy on M30
input ENUM_STRATEGY Strategy_H1 = STRAT_PIVOT;      // Strategy on H1
input ENUM_STRATEGY Strategy_H2 = STRAT_ASI;        // Strategy on H2
input ENUM_STRATEGY Strategy_H3 = STRAT_AMA;        // Strategy on H3
input ENUM_STRATEGY Strategy_H4 = STRAT_FORCE;      // Strategy on H4
input ENUM_STRATEGY Strategy_H6 = STRAT_FRACTALS;   // Strategy on H6
input ENUM_STRATEGY Strategy_H8 = STRAT_ENVELOPES;  // Strategy on H8
input ENUM_STRATEGY Strategy_H12 = STRAT_AD;        // Strategy on H12
...
#endif
input int EA_SignalOpenFilterMethod = 101;   // Open(1=!BarO,2=Trend,4=PP,8=OppO,16=Peak,32=BetterO,64=InLoss)
input int EA_SignalCloseFilterMethod = 104;  // Close(1=!BarO,2=!Trend,4=!PP,8=O>H,16=Peak,32=BetterO,64=InProfit)
