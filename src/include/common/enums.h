...
enum ENUM_STRATEGY_TYPE {  // Define type of strategies.
  // Type of strategy being used (used for strategy identification, new strategies append to the end, but in general -
  // do not change!).
  AC1,
  AC5,
  AC15,
...
enum ENUM_MARKET_EVENT {
  ...
  C_BULLSPOWER_BUY_SELL = 9,   // BullsPower on buy/sell
  ...
  C_MA_FAST_SLOW_OPP = 30,     // MA Fast&Slow opposite
  C_MA_FAST_MED_OPP = 31,      // MA Fast&Med opposite
  C_MA_MED_SLOW_OPP = 32,      // MA Med&Slow opposite
  C_ZIGZAG_BUY_SELL = 33,      // ZigZag on buy/sell
#ifdef __advanced__
