...
#endif
input ENUM_STRATEGY EA_Stops_Strat = STRAT_AC;   // Stop loss strategy
...
#endif
input int EA_SignalOpenFilterMethod = 36;   // Open (1=!BarO,2=Trend,4=PP,8=OppO,16=Peak,32=BetterO,64=!Eq<1%)
